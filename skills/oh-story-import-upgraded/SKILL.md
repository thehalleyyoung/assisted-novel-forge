...
Part of oh-story suite (`worldwonderer/oh-story-claudecode@story-import`). Orchestrate via `/assisted-novel-forge` / `story-upgraded`. Done via verify_gate.py.
