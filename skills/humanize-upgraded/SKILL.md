...
Upstream `humanizerai/agent-skills@humanize`. Ensemble member for `/assisted-novel-forge` after craft; emit/update `review/ai_tells_report.json`. Done via verify_gate.py.
