---
name: oh-story-long-analyze-upgraded
version: 1.0.0
...
Part of oh-story suite (`worldwonderer/oh-story-claudecode@story-long-analyze`). Orchestrate via `/assisted-novel-forge` / `story-upgraded`. Done via verify_gate.py.
