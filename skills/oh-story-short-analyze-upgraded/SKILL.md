---
name: oh-story-short-analyze-upgraded
version: 3.0.0
...
Part of oh-story suite (`worldwonderer/oh-story-claudecode@story-short-analyze`). Orchestrate via `/assisted-novel-forge` / `story-upgraded`. Done via verify_gate.py.
