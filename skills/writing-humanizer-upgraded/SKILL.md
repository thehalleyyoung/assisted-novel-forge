---
name: writing-humanizer-upgraded
version: 2.1.1
description: |
...
## Remix — anti-AI-tells lane
Upstream `hairyf/skills@writing-humanizer`. Ensemble member for `/assisted-novel-forge` after craft; emit/update `review/ai_tells_report.json`. Done via verify_gate.py.
