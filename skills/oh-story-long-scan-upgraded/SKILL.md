---
name: oh-story-long-scan-upgraded
version: 1.0.0
...
Part of oh-story suite (`worldwonderer/oh-story-claudecode@story-long-scan`). Orchestrate via `/assisted-novel-forge` / `story-upgraded`. Done via verify_gate.py.
