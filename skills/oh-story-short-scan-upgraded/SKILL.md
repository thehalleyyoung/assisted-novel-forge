---
name: oh-story-short-scan-upgraded
version: 1.0.0
...
Part of oh-story suite (`worldwonderer/oh-story-claudecode@story-short-scan`). Orchestrate via `/assisted-novel-forge` / `story-upgraded`. Done via verify_gate.py.
