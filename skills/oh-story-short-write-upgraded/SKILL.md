---
name: oh-story-short-write-upgraded
version: 1.0.0
...
Part of oh-story suite (`worldwonderer/oh-story-claudecode@story-short-write`). Orchestrate via `/assisted-novel-forge` / `story-upgraded`. Done via verify_gate.py.
